...
const views = [
  {
    ...
    logo: (color = '#D132F9') => (
      <svg width="13" height="17" viewBox="0 0 13 17" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M4.91663 3.22217H9.66663V4.27772H4.91663V3.22217Z" fill={color} />
        <path d="M4.91663 5.33337H9.66663V6.38893H4.91663V5.33337Z" fill={color} />
        <path d="M4.91663 7.44446H9.66663V8.50001H4.91663V7.44446Z" fill={color} />
        <path d="M4.91663 9.55554H9.66663V10.6111H4.91663V9.55554Z" fill={color} />
        <path d="M4.91663 11.6666H9.66663V12.7222H4.91663V11.6666Z" fill={color} />
        <path d="M2.80554 3.22217H3.8611V4.27772H2.80554V3.22217Z" fill={color} />
        <path d="M2.80554 5.33337H3.8611V6.38893H2.80554V5.33337Z" fill={color} />
        <path d="M2.80554 7.44446H3.8611V8.50001H2.80554V7.44446Z" fill={color} />
        <path d="M2.80554 9.55554H3.8611V10.6111H2.80554V9.55554Z" fill={color} />
        <path d="M2.80554 11.6666H3.8611V12.7222H2.80554V11.6666Z" fill={color} />
        <path
    ...
    <Container>
      {views.map((view, index) => (
        ...
        >
          ...
          {view.logo(theme.colors.primary)}
          {view.title}
        </ViewButton>
      ))}
    </Container>
